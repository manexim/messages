...
public class Dialogs.MessengerUpdateDialog : Granite.Dialog {
    ...
    public MessengerUpdateDialog (Gtk.Window parent, Models.Messenger messenger) {
        Object (
    ...
    construct {
        ...
        create_button = (Gtk.Button) add_button (_("Update"), Gtk.ResponseType.OK);
        ...
        response.connect ((response_id) => {
            if (response_id == Gtk.ResponseType.OK) {
                ...
                var updated_messenger = new Models.Messenger () {
                    id = messenger.id,
                    name = name,
                    url = url,
                    unread_notifications = messenger.unread_notifications
                };

                Services.Messengers.get_default ().update (messenger.name, updated_messenger);
            }
